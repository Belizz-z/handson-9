...
public class IntroToAbstractionPractice {
    public static void main(String[] args) {
        ...
        System.out.println("1. abstraction itu menyederhanakan kompleksitas");
        System.out.println("2. tidak perlu menulis ulang");
        System.out.println("3. bisa memaksa aturan");
        System.out.println("4. gampang diubah");
        System.out.println("5. mencegah objek yang aneh");
